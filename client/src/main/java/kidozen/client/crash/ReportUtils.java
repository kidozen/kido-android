...
public final class ReportUtils {
    ...
    public static String getDeviceId(Context context) {
        try {
            ...
            Log.w(LOG_TAG, "Couldn't retrieve DeviceId for : " + context.getPackageName(), e);
            return null;
        }
    }
    ...
    public static String getApplicationFilePath(Context context) {
        ...
        Log.w(LOG_TAG, "Couldn't retrieve ApplicationFilePath for : " + context.getPackageName());
    ...
    public static String getLocalIpAddress() {
        ...
        try {
            ...
            CrashReporter.log.w(LOG_TAG, ex.toString());
        }
        return result.toString();
    }
}
