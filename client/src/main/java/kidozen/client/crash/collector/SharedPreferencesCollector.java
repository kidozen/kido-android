...
final class SharedPreferencesCollector {
    ...
    public static String collect(Context context) {
        ...
        final String[] shrdPrefsIds = CrashReporter.getConfig().additionalSharedPreferences();
    ...
    private static boolean filteredKey(String key) {
        for (String regex : CrashReporter.getConfig().excludeMatchingSharedPreferencesKeys()) {
