...
class LogCatCollector {
    ...
    public static String collectLogCat(String bufferName) {
        ...
        if (CrashReporter.getConfig().logcatFilterByPid() && myPid > 0) {
        ...
        final List<String> logcatArgumentsList = new ArrayList<String>(
                Arrays.asList(CrashReporter.getConfig().logcatArguments()));
        ...
        try {
            ...
            Log.e(CrashReporter.LOG_TAG, "LogCatCollector.collectLogCat could not retrieve data.", e);
        }
