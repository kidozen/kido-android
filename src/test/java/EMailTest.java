...
public class EMailTest {
    ...
    public void ShouldSendEmail() throws Exception {
        ...
        Mail mail = new Mail();
        mail.to(TestConfiguration.KZ_EMAIL_TO);
        mail.from(TestConfiguration.KZ_EMAIL_FROM);
    ...
    public void ShouldAttachFiles() throws Exception {
        ...
        attachs.add(TestConfiguration.KZ_EMAIL_ATTACH);
    ...
    public void ShouldSendEmailWithMultipleRecipients() throws Exception {
        final CountDownLatch lcd = new CountDownLatch(1);
        Mail mail = new Mail();
        mail.to(TestConfiguration.KZ_EMAIL_TO + "," +  TestConfiguration.KZ_EMAIL_FROM);
        mail.from(TestConfiguration.KZ_EMAIL_FROM);
        mail.subject(this.CreateRandomValue());
        mail.textBody(this.CreateRandomValue());
